...
AI receptionist for Roofing companies. Answers calls 24/7, books appointments, texts technicians.

**Status:** Pre-launch (leads generated, backend tested, ready to deploy)  
**Pricing:** $1,800/mo + $2,000 setup (discounts available)  
...
| File | Purpose |
|------|---------|
| `scraper.py` | Generate Roofing leads (sample data or Google Places API) |
