...
AI receptionist for Locksmith companies. Answers calls 24/7, books appointments, texts technicians.

**Status:** Pre-launch (leads generated, backend tested, ready to deploy)  
**Pricing:** $800/mo + $1,000 setup (discounts available)  
...
| File | Purpose |
|------|---------|
| `scraper.py` | Generate Locksmith leads (sample data or Google Places API) |
