...
AI receptionist for Electrical companies. Answers calls 24/7, books appointments, texts technicians.
...
| File | Purpose |
|------|---------|
| `scraper.py` | Generate Electrical leads (sample data or Google Places API) |
