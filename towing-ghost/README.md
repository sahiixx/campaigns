...
AI receptionist for Towing companies. Answers calls 24/7, books appointments, texts technicians.

**Status:** Pre-launch (leads generated, backend tested, ready to deploy)  
**Pricing:** $900/mo + $1,200 setup (discounts available)  
...
| File | Purpose |
|------|---------|
| `scraper.py` | Generate Towing leads (sample data or Google Places API) |
