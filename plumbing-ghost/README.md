...
AI receptionist for Plumbing companies. Answers calls 24/7, books appointments, texts technicians.
...
| File | Purpose |
|------|---------|
| `scraper.py` | Generate Plumbing leads (sample data or Google Places API) |
